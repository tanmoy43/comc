...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    ...
    <tr>
        ...
        //var_dump($complain_id);
         $sql = mysqli_query($conn,"SELECT complain_remark_city.remark as remark,complain_remark_city.status as sstatus,complain_remark_city.remark_date as rdate from complain_remark_city join complain_from_city on complain_from_city.complain_id=complain_remark_city.complain_id where complain_from_city.complain_id='$complain_id'");
         //var_dump($sql);
