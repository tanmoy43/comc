...
if(isset($_POST['update_btn'])){
    ...
    $query = "UPDATE complain_from_police SET status='$status' where id='$id'";
    $e_fire = mysqli_query($conn, $query);

    $sql = "INSERT into complain_remark_police(complain_id, status,	remark) VALUE ('$complain_id', '$status', '$remark')";
